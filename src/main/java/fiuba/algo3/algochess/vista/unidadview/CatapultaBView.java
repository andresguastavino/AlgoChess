...
public class CatapultaBView extends UnidadView {
    public CatapultaBView(Unidad unidad, TableroView tableroView) {
        super(unidad, tableroView, new Sprite("src/main/resources/catapultaB.png"));
    }
